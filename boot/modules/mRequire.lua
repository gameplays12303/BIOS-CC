...
local expect = require and require("modules.expect2") or dofile("boot/modules/expect2.lua")
...
function handle.setErrorHandler(errorFn)
    expect(false,1,errorFn,"function")
    error = errorFn
end
